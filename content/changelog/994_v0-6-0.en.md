...
## BREAKING
- Introducing many filter options for the "\<bom/component/vulnerability/csaf/product/user/user-role/role-permission\> list" commands. Some of these replace previous options, and the communication between sever and client has also been adjusted in places, which is why this is a breaking change. Albeit not very breaking.
