...
- The client can be provided with an mTLS certificate, to authenticate against an external CSAF server. This grants access to CSAF documents that are classified as something other than {{<tlp-white>}}/{{<tlp-clear>}}, because mTLS is the mechanism several providers use for authentication.
