...
name = "<name>"
period = "<period>"
scheduled = true # Optional, true ist der Standard.
...
> [!INFO]
> Die doppelten Klammern um "tasks" markieren den Abschnitt als Eintrag in einer Liste. Deswegen darf er mehrfach vorkommen.
...
> Streng genommen spezifiert er nur die minimale Zeit zwischen zwei Ausführungen, da alle zyklischen Aufgaben im selben Thread ausgeführt werden und sich somit gegenseitig verzögern können.

Die Zeitspanne kann im (englischen) menschenlesbaren Format spezifiziert werden, beispielsweise "2 days" oder "3h". Falls sie nicht angegeben wird, fällt sie auf den Wert "1 day" zurück, und die Aufgabe wird etwa alle 24 Stunden ausgeführt.
