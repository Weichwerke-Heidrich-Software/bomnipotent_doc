...
Running the command "component analyze" and providing it with one or more filepaths to valid CycloneDX files displays the (combined) components of these BOMs:
