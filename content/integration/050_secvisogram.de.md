...
> [!INFO]
> Beginnend mit Version 1.6.0 von BOMnipotent können Sie das Programm nutzen, um [CSAF Dokumente zu generieren](/de/client/manager/doc-management/csaf-docs/#generieren). Diese Methode bietet zwar nicht die volle Flexibilität von Secvisogram, benötigt allerdings *deutlich* weniger Eingaben und ist für die meisten Use-Cases ausreichend.
